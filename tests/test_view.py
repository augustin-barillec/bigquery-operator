...
class ViewTest(ut.base_class.BaseClassTest):
    ...
    def test_create_view(self):
        ut.operators.operator.create_view('select 3', 'table_name_1', time_to_live=1)
        ...
        ut.operators.operator.create_view('select 4', 'table_name_2', pre_delete_if_exists=True)
